...
with col2:
    st.markdown("<div class='header' style='background-color: #941411;'><h1>RedPulse AI</h1><p>Esta herramienta utiliza inteligencia artificial para evaluar tu riesgo de desarrollar problemas cardiovasculares basándose en múltiples factores de salud y estilo de vida. Completa tu información a continuación y obtén tu evaluación personalizada.</p></div>", unsafe_allow_html=True)


# Organización en columnas
with st.container():
    st.markdown("<div class='section'><h4 style='color:#941411'>📝 Datos Personales</h4></div>", unsafe_allow_html=True)
    ...
    val20 = st.slider("**Glucosa en sangre (mg/dL)**", min_value=70, max_value=180, step=1, value=70)
    val21 = st.slider("**Colesterol HDL (mg/dL)**", min_value=30, max_value=90, step=1, value=30)
    val22 = st.slider("**Colesterol LDL (mg/dL)**", min_value=60, max_value=180, step=1, value=60)
